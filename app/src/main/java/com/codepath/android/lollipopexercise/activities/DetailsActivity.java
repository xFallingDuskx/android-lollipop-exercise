...
//                Glide.with(this).asBitmap().load(resource).centerCrop().into(ivProfile);
                ...
                vPalette.setBackgroundColor(palette.getVibrantColor(getResources().getColor(R.color.design_default_color_background)));
            }
